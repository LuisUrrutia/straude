...
Direct favicon discovery shipped on 2026-09-05. It prefers sanitized SVG, uses declared HTML and manifest icons, and falls back to proportionally resized PNG or decoded ICO within a finite request budget. Assets stay in Supabase Storage; Google and Open Graph preview images are no longer part of discovery. The design and limits are recorded in `docs/DECISIONS.md`.
